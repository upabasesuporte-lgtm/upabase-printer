-- ============================================================
-- Correcao: register_purchase tentava gravar em stock_movements
-- usando colunas que nao existem nessa tabela no seu banco
-- (stock_item_id, cost_price, notes, reference_type). Essa tabela
-- ja estava com esse problema antes desta integracao, em todo o
-- sistema (PDV, ajustes manuais) - so nao aparecia porque o codigo
-- antigo nunca checava erro nesse insert especifico.
--
-- Esta correcao so remove a tentativa de gravar nessa tabela de
-- dentro do register_purchase. Estoque e Contas a Pagar continuam
-- sendo atualizados/criados normalmente, dentro da mesma transacao.
-- ============================================================
